        ...
        <div className="container">
          <div className="personal__head text-center">
            ...
            <p className="descrp" data-aos="fade-up" data-aos-duration="1500">
              "Ich bin Hussam Alnabelsi, zertifizierter Fachinformatiker und Full-Stack-Experte. Mein Fokus liegt auf React, 
              Angular sowie ASP.NET Core, PHP Laravel und Node.js. 
              Zudem entwickle ich leistungsstarke Mobile Apps mit Flutter und Dart, 
              um komplexe Anforderungen in erstklassige, skalierbare digitale Lösungen zu verwandeln.        
               </p>
          </div>
